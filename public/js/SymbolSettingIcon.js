                ...
                <Card className='mt-1'>
                  <Card.Header className='px-2 py-1'>
                    <Accordion.Toggle
                      ...
                      ATH (All Time High) Price Determination Candle Settings
                    </Accordion.Toggle>
                  </Card.Header>
                        ...
                        <div className='col-6'>
                          <Form.Group
                            ...
                            <Form.Control
                              ...
                              as='select'
                              required
                              data-state-key='athCandles.interval'
                              value={symbolConfiguration.athCandles.interval}
                        ...
                        <div className='col-6'>
                          <Form.Group
                            ...
                            <Form.Control
                              ...
                              min='0'
                              step='1'
                              data-state-key='athCandles.limit'
                              value={symbolConfiguration.athCandles.limit}
                              onChange={this.handleInputChange}
                            />
                          </Form.Group>
                        </div>
                        ...
                        <div className='col-xs-12 col-sm-6'>
                          ...
                          <Form.Group
                            ...
                            <Form.Control
                              ...
                              min='0'
                              step='0.0001'
                              data-state-key='buy.restrictionPercentage'
                              value={
                                symbolConfiguration.buy.restrictionPercentage
                              }
                              onChange={this.handleInputChange}
                            />
                          </Form.Group>
