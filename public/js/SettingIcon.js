                          ...
                          <div className='col-12'>
                            <Form.Group
                              ...
                              <Form.Check size='sm'>
                                ...
                                />
                                <Form.Check.Label>
                                  Reduce the sell trigger price proportionally
                                  to the number of executed buy grids - applies
                                  only to grids with at least 2 executed buy
                                  trades{' '}
                                  <OverlayTrigger
                                    trigger='click'
                                    ...
                                    overlay={
                                      <Popover id='sell-conservative-enabled-overlay-right'>
                                        <Popover.Content>
                                          ...
                                          conservative ratio for each executed
                                          buy grid. You can use this feature in
                                          bear market conditions to secure
                                          smaller benefits over unreached higher
                                          gains. At least 2 buy trades must have
                                          been executed for the ratio to be
                                          applied.
                                        </Popover.Content>
                                      </Popover>
                                    }>
                          ...
                          <div className='col-xs-12 col-sm-6'>
                            <Form.Group
                                ...
                                <OverlayTrigger
                                  ...
                                  overlay={
                                    <Popover id='sell-conservative-factor-overlay-right'>
                                      <Popover.Content>
                                        Set the conservative factor to be
                                        applied on sell trades with at least 2
                                        executed buy grids. i.e. if set to{' '}
                                        <code>0.90</code>, your current grid
                                        sell percentage will be reduced by{' '}
                                        <code>10%</code> for each executed buy
                                        grid (except the first one). For
                                        example, if your sell trigger percentage
                                        is <code>1.10</code>, and you have 3
                                        executed buy grids, the sell order
                                        trigger will be <code>1.081</code>.
                                        Remember the sell trigger is not
                                        modified if you have only 1 executed buy
                                        grid.
                                      </Popover.Content>
                                    </Popover>
                                  }>
                              ...
                              <Form.Control
                                ...
                                value={
                                  configuration.sell.conservativeMode.factor
                                }
                                onChange={this.handleInputChange}
                              />
                            </Form.Group>
