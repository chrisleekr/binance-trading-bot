  ...
  getQuoteAssets(
    ...
    selectedSymbols.forEach(symbol => {
      ...
      if (minPurchaseAmounts[quoteAsset] === undefined) {
        ...
        minPurchaseAmounts[quoteAsset] = (minNotional * 1.1).toFixed(
          minNotional.length
        );
      }
    });
                        ...
                        <div className='col-12'>
                          <Form.Group className='mb-2'>
                            <Typeahead
                              ...
                              placeholder={
                                setting_icon.placeholder_monitor_symbols
                              }
                            />
                          </Form.Group>
                        </div>
                              ...
                              <Form.Group
                                ...
                                <InputGroup size='sm'>
                                  ...
                                  <InputGroup.Append>
                                    <InputGroup.Text>
                                      {(
                                        configuration.buy.stopPercentage * 100 -
                                        100
                                      ).toFixed(2)}
                                      %
                                    </InputGroup.Text>
                              ...
                              <Form.Group
                                ...
                                <InputGroup size='sm'>
                                  ...
                                  <InputGroup.Append>
                                    <InputGroup.Text>
                                      {(
                                        configuration.buy.limitPercentage *
                                          100 -
                                        100
                                      ).toFixed(2)}
                                      %
                              ...
                              <Form.Group
                                ...
                                <InputGroup size='sm'>
                                  ...
                                  <InputGroup.Append>
                                    <InputGroup.Text>
                                      {(
                                        (configuration.buy.triggerPercentage -
                                          1) *
                                        100
                                      ).toFixed(2)}
                                      %
                              ...
                              <Form.Group
                                ...
                                <InputGroup size='sm'>
                                  ...
                                  <InputGroup.Append>
                                    <InputGroup.Text>
                                      {(
                                        configuration.sell.stopPercentage *
                                          100 -
                                        100
                                      ).toFixed(2)}
                                      %
                              ...
                              <Form.Group
                                ...
                                <InputGroup size='sm'>
                                  ...
                                  <InputGroup.Append>
                                    <InputGroup.Text>
                                      {(
                                        configuration.sell.limitPercentage *
                                          100 -
                                        100
                                      ).toFixed(2)}
                                      %
                              ...
                              <Form.Group
                                ...
                                <InputGroup size='sm'>
                                  ...
                                  <InputGroup.Append>
                                    <InputGroup.Text>
                                      {(
                                        configuration.sell.triggerPercentage *
                                          100 -
                                        100
                                      ).toFixed(2)}
                                      %
                              ...
                              <Form.Group
                                ...
                                <Form.Check size='sm'>
                                  <Form.Check.Input
                                    ...
                                    checked={
                                      configuration.strategyOptions.tradeOptions
                                        .manyBuys
                                    }
                                    onChange={this.handleInputChange}
                                  />
          ...
          <Modal.Header className='pt-1 pb-1'>
            <Modal.Title>
              <span className='text-danger'>
                ⚠ {setting_icon.reset_factory.delete_all}
              </span>
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
