                        ...
                        <div className='col-6'>
                          <Form.Group
                            ...
                            <Form.Check size='sm'>
                              <Form.Check.Input
                                type='checkbox'
                                data-state-key='botOptions.authentication.lockList'
                                checked={
                                  configuration.botOptions.authentication
                                    .lockList
                                }
                                onChange={this.handleInputChange}
                              />
                                ...
                                <OverlayTrigger
                                  ...
                                  overlay={
                                    <Popover id='bot-options-lock-list-overlay-right'>
                                      <Popover.Content>
                                        If enabled, the bot will show the login
                                        screen before showing the list. If
                                        disabled, the bot will display the list,
                                        but all actions will be disabled. To
                                        unlock, click the icon{' '}
                        ...
                        <div className='col-6'>
                          <Form.Group
                            ...
                            <Form.Label className='mb-0'>
                              ...
                              <OverlayTrigger
                                ...
                                overlay={
                                  <Popover id='limit-overlay-right'>
                                    <Popover.Content>
                                      Set the minutes to allow authentication.
                                      Once pass the configured minutes, the bot
                            ...
                            <Form.Control
                              ...
                              min='1'
                              step='1'
                              data-state-key='botOptions.authentication.lockAfter'
                              value={
                                configuration.botOptions.authentication
                                  .lockAfter
                              }
