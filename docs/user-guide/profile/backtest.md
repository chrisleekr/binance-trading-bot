...
![Backtest History tab](../../assets/screenshots/user-guide/profile-backtest-history.png)

_The History tab: every past run, ready to reopen or compare. Seeded demo data, not a real account._
